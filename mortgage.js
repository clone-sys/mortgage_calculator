...
function getRate() {
  const annualRate = readlineSync.questionInt('What is the annual rate of the loan?')
...
function getTerm() {
  const term = readlineSync.questionInt('What is the term (in years) of the loan?')
